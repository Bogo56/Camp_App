...
const seedDB = async (user_id) =>  {
    ...
    for (let dest of destinationsBG){
        let loc = new destModel({
            ...
            images:[ 
                { url : 
                    `https://res.cloudinary.com/dawb3psft/image/upload/v1636315395/CampProject/dest_${i}_image_${1}.jpg`,
                    "filename" : `CampProject/dest_${i}_image_${1}.jpg`
                },
                { url : 
                    `https://res.cloudinary.com/dawb3psft/image/upload/v1636315395/CampProject/dest_${i}_image_${2}.jpg`,
                    "filename" : `CampProject/dest_${i}_image_${2}.jpg`
                },
                { url : 
                    `https://res.cloudinary.com/dawb3psft/image/upload/v1636315395/CampProject/dest_${i}_image_${3}.jpg`,
